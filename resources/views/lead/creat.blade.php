                                    ...
                                    <h1>
                                        <div name="name" class="o_field_widget">
                                            <div style="height: 45px;">
                                                <textarea class="o_input" id="name_0" style="width: 1000px" value="{{ isset($data) ? $data->product_name : '' }}"
                                                    placeholder="e.g. Product Pricing" rows="1" spellcheck="false"
                                                    style="height: 45px; border-top-width: 0px; border-bottom-width: 1px; padding: 1px 0px;">{{ isset($data) ? $data->product_name : '' }}</textarea>
                                            </div>
                                        </div>
                                    </h1>
                                            ...
                                            <div id="probability" class="d-flex align-items-baseline">
                                                <div name="probability"
                                                    ...
                                                    <input inputmode="decimal" class="o_input"
                                                        value="{{ isset($data) ? $data->probability : '' }}"
                                                        autocomplete="off" id="probability_0" type="text">
                                        ...
                                        <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                            ...
                                            <div class="o_cell flex-grow-1 flex-sm-grow-0" style="width: 100%;">
                                                <div class="o_address_format">
                                                    ...
                                                    <div name="street2"
                                                        class="o_field_widget o_field_char o_address_street"><input
                                                            class="o_input" id="street2_0"
                                                            value="{{ isset($data) ? $data->address_2 : '' }}"
                                                            type="text" autocomplete="off" placeholder="Street 2...">
                                                    </div>
                                                    <div name="city"
                                                    ...
                                                    <div name="zip" class="o_field_widget o_field_char o_address_zip">
                                                        ...
                                                        <input class="o_input" value="{{ $zip }}"
                                                            id="zip_0" type="text" autocomplete="off"
                                                            placeholder="ZIP">
                                                    </div>
                                                    <div name="state_id"
                                                                ...
                                                                <div class="o-mail-Message-core position-relative d-flex flex-shrink-0">
                                                                    ...
                                                                    <div class="w-100 o-min-width-0">
                                                                        <div class="o-mail-Message-header d-flex flex-wrap align-items-baseline lh-1 mb-1">
                                                                            <span class="o-mail-Message-author small cursor-pointer o-hover-text-underline" aria-label="Open card"><strong class="me-1">info@yantradesign.co.in</strong></span><small class="o-mail-Message-date text-muted smaller" title="13/8/2024, 2:12:31 pm">- now</small>
                                                                        </div>
                                        ...
                                        <div class="lead-details">
                                            <div class="lead-box">
                                                <div class="lead-details-img row justify-content-between mb-3">
                                                    <img
                                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNj_OgfNeyTLpUGGG2O7x3-asrzFB6RLPebQ&s">
                                                    <img
                                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNj_OgfNeyTLpUGGG2O7x3-asrzFB6RLPebQ&s">
                                                </div>
                                            ...
                                            <div class="main-lead-user-info row">
                                                <div class="lead-user-info">
                                                    <p>Shubham Rajput</p>
                                                    <p>
                                                        Jbmi Agri Private Limited, SIETZ TECHNOLOGIES INDIA PVT LTD
                                                        FARIDABAD HARYANASECTOR-6 FARIDABAD HARYANA, Pithampur - 454755, MP
                                                    </p>
                                                    <p>
                                                        Click to Call : <a href="tel:+918171656128">+91-8171656128</a>
                                                    </p>
                                                    <p>
                                                        E-mail : <a
                                                            href="mailto:shubham.rajput@sietz-india.com">shubham.rajput@sietz-india.com</a>
                                                    </p>
                                                    <span>
