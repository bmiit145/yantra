...
@section('content')
    ...
    <body>
        ...
        <button type="button" class="o_form_button_save btn btn-light px-1 py-0 lh-sm" id="main_save_btn"
            data-hotkey="s" data-tooltip="Save manually" aria-label="Save manually" title="Save Button">
                            ...
                            <div class="o_form_sheet_bg">
                                <div
                                    ...
                                    <div
                                        ...
                                        <button invisible="not active or not id" class="btn btn-secondary" name="426"
                                            type="action"><span>Launch Plan</span></button>
                                    </div>
                                </div>
                                <div class="o_form_sheet position-relative">
                                            ...
                                            <div class="oe_title mw-75 ps-0 pe-2">
                                                <h1 class="d-flex flex-row align-items-center">
                                                    <div name="name"
                                                        ...
                                                        style="font-size: min(4vw, 2.6rem);"><input class="o_input"
                                                            name="name" id="name_0" type="text"
                                                            value="{{ $employee->name ?? '' }}" autocomplete="off"
                                                            placeholder="Employee's Name"></div>
                                                </h1>
                                                <h2>
                                                    <div name="job_title" class="o_field_widget o_field_char"><input
                                                            class="o_input" name="job_title" id="job_title_0"
                                                            value="{{ $employee->job_title ?? '' }}" type="text"
                                                    ...
                                                    <div class="d-inline-block position-relative opacity-trigger-hover">
                                                        ...
                                                        <div aria-atomic="true"
                                                            ...
                                                            <span style="display:contents">
                                                                <button id="edit-image-button" type="button"
                                                            ...
                                                            <input type="file" id="profile-image-input"
                                                                name="profile_image" class="o_input_file d-none"
                                                                accept="image/*">

                                                        </div>
                                                        <img id="profile-image" loading="lazy" class="img img-fluid"
                                                            alt="Profile Image"
                                                            src="{{ asset('uploads/' . ($employee->profile_image ?? 'default.png')) }}"
                                                            name="image_1920">
                                                    ...
                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                        ...
                                                        <div name="mobile_phone" class="o_field_widget o_field_phone">
                                                            <div class="o_phone_content d-inline-flex w-100"><input
                                                                    class="o_input" name="work_mobile" type="tel"
                                                                    value="{{ $employee->work_mobile ?? '' }}"
                                                                    autocomplete="off" id="mobile_phone_0"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                                    ...
                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                        ...
                                                        <div name="work_phone" class="o_field_widget o_field_phone">
                                                            <div class="o_phone_content d-inline-flex w-100"><input
                                                                    class="o_input" name="work_phone" type="tel"
                                                                    value="{{ $employee->work_phone ?? '' }}"
                                                                    autocomplete="off" id="work_phone_0"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                                    ...
                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                        ...
                                                        <div name="category_ids"
                                                                    ...
                                                                    <div class="o_input_dropdown">
                                                                        <div class="o-autocomplete dropdown">
                                                                            <input type="text" name="tags"
                                                                                ...
                                                                                aria-expanded="false">
                                                                            <ul id="tags-dropdown"
                                                                                class="o-autocomplete--dropdown-menu ui-widget dropdown-menu ui-autocomplete">
                                                                            </ul>
                                                                        </div>
                                                            ...
                                                            <div id="tags-container"
                                                                class="d-inline-flex flex-wrap gap-1 mw-100 mt-2"></div>
                                                ...
                                                <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                                    <div
                                                        ...
                                                        <label class="o_form_label"
                                                            for="department_id_0">Department</label>
                                                    </div>
                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                        style="width: 100%;">
                                                            ...
                                                            <div class="o_field_many2one_selection">
                                                                <div class="o_input_dropdown">
                                                                    <div class="o-autocomplete dropdown"><input
                                                                            ...
                                                                            aria-haspopup="listbox" id="department_id_0"
                                                            ...
                                                            <div class="o_field_many2one_selection">
                                                                <div class="o_input_dropdown">
                                                                    <div class="o-autocomplete dropdown"><input
                                                                            ...
                                                                            aria-haspopup="listbox" id="job_id_0"
                                                                ...
                                                                <div class="o_field_many2one_selection">
                                                                    <div class="o_input_dropdown">
                                                                        <div class="o-autocomplete dropdown"><input
                                                                                ...
                                                                                aria-haspopup="listbox" id="parent_id_0"
                                                                                placeholder="" aria-expanded="false">
                                                                        </div><span class="o_dropdown_button"></span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="o_field_many2one_selection">
                                                                    <div class="o_input_dropdown">
                                                                        <div class="o-autocomplete dropdown"><input
                                                                                ...
                                                                                aria-haspopup="listbox" id="coach_id_0"
                                                                                placeholder="" aria-expanded="false">
                                                                        </div><span class="o_dropdown_button"></span>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="o_notebook d-flex w-100 horizontal flex-column">
                                            ...
                                            <ul class="nav nav-tabs flex-row flex-nowrap">
                                                <li class="nav-item flex-nowrap cursor-pointer">
                                                    <a class="nav-link active" href="#" role="tab"
                                                        tabindex="0" name="resume">Resume</a>
                                                </li>
                                                <li class="nav-item flex-nowrap cursor-pointer">
                                                    <a class="nav-link" href="#" role="tab" tabindex="0"
                                                        name="work_information">Work Information</a>
                                                </li>
                                                <li class="nav-item flex-nowrap cursor-pointer">
                                                    <a class="nav-link" href="#" role="tab" tabindex="0"
                                                        name="personal_information">Private Information</a>
                                                </li>
                                                <li class="nav-item flex-nowrap cursor-pointer">
                                                    <a class="nav-link" href="#" role="tab" tabindex="0"
                                                        name="hr_settings">HR Settings</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div role="dialog" id="newResumeModal" class="modal  o_technical_modal"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content o_form_view" style="top: 0px; left: 0px;">
                                                    <header class="modal-header">
                                                        <h4 class="modal-title text-break">New Resume line</h4><button
                                                    ...
                                                    <form action="" id="employee-form" method="POST">
                                                        @csrf
                                                        <input type="hidden" class="experience_id" name="experience_id"
                                                            value="{{ $employee->id ?? '' }}">

                                                        <main class=" modal-body p-0">
                                                            <div
                                                                class="o_form_renderer o_form_editable d-flex d-print-block flex-nowrap h-100">
                                                                <div class="o_form_sheet_bg">
                                                                    <div class="o_form_sheet position-relative">
                                                                        <div class="oe_title"><label class="o_form_label"
                                                                                for="name_0">Title</label>
                                                                            <h1>
                                                                                <div name="name"
                                                                                    class="o_field_widget o_required_modifier o_field_char">
                                                                                    <input name="experience_title"
                                                                                        class="o_input o_field_translate experience_title"
                                                                                        id="edit_name_0" type="text"
                                                                                        autocomplete="off"
                                                                                        placeholder="e.g. Odoo Inc."></div>
                                                                            </h1>
                                                                        </div>
                                                                        <div class="o_group row align-items-start">
                                                                            <div class="o_inner_group grid col-lg-6">
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                                        <label class="o_form_label"
                                                                                            for="employee_id_get">Employee</label>
                                                                                    </div>
                                                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                                        style="width: 100%;">
                                                                                        <div name="employee_id"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <button type="button"
                                                                                                    class="btn btn-link text-action oi o_external_button oi-launch"
                                                                                                    tabindex="-1"
                                                                                                    draggable="false"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                                        <label class="o_form_label"
                                                                                            for="line_type_id_0">Type</label>
                                                                                    </div>
                                                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                                        style="width: 100%;">
                                                                                        <div name="line_type_id"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            class="o-autocomplete--input o_input experience_type"
                                                                                                            autocomplete="off"
                                                                                                            role="combobox"
                                                                                                            aria-autocomplete="list"
                                                                                                            aria-haspopup="listbox"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                                        <label class="o_form_label"
                                                                                            for="display_type_0">Display
                                                                                            Type</label>
                                                                                    </div>
                                                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                                        style="width: 100%;">
                                                                                        <div name="display_type"
                                                                                            class="o_field_widget o_required_modifier o_field_selection">
                                                                                            <select
                                                                                                name="experience_display_type"
                                                                                                class="o_input pe-3 experience_display_type"
                                                                                                id="edit_experience_display_type">
                                                                                                <option value="false"
                                                                                                    style="display:none">
                                                                                                </option>
                                                                            ...
                                                                            <div class="o_inner_group grid col-lg-6">
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                                        <label class="o_form_label"
                                                                                            for="date_start_0">Duration</label>
                                                                                    </div>
                                                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                                        style="width: 100%;">
                                                                                        ...
                                                                                        <div name="date_start"
                                                                                            class="o_field_widget o_required_modifier o_field_daterange">
                                                                                            <div
                                                                                                class="d-flex gap-2 align-items-center">
                                                                                                <input type="text"
                                                                                                    name="experience_start_date"
                                                                                                    class="o_input cursor-pointer experience_start_date"
                                                                                                    autocomplete="off"
                                                                                                    id="date_start_0"
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    class="o_input cursor-pointer experience_end_date"
                                                                                                    name="experience_end_date"
                                                                                                    autocomplete="off"
                                                                                                    id="date_end_0"
                                                                                                    data-field="date_end">
                                                                        ...
                                                                        <div name="description"
                                                                            ...
                                                                            <div style="height: 50px;">
                                                                                <textarea name="experience_description" class="o_input o_field_translate experience_description" id="description_0"
                                                                                    placeholder="Description" rows="2"
                                                                                    style="height: 50px; border-top-width: 0px; border-bottom-width: 1.11111px; padding: 1px 25px 1px 0px;"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <footer
                                                        class="modal-footer justify-content-around justify-content-md-start flex-wrap gap-1 w-100">
                                                        <button class="btn btn-primary o_form_button_save_data"
                                                            data-hotkey="c">Save &amp; Close</button>
                                                        <button class="btn btn-primary o_form_button_save_new"
                                                            data-hotkey="n">Save &amp; New</button>
                                                        <button class="btn btn-secondary o_form_button_cancel"
                                                            data-hotkey="j">Discard</button>
                                                    </footer>
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tbody class="ui-sortable">
                                                                            ...
                                                                            @php
                                                                                ...
                                                                                if (isset($employee)) {
                                                                                    $experiences = \App\Models\Experience::where(
                                                                                        'employee_id',
                                                                                        $employee->id,
                                                                                    )->get();
                                                                                }
...
>>>>>>> d1415120bf6556097ea9c8cf15b63dce9c167815
                                                                                            ...
                                                                                            <small
                                                                                                class="o_resume_line_dates fw-bold">
                                                                                    ...
                                                                                    <td class="o_list_record_remove w-print-0 p-print-0 text-center"
                                                                                        tabindex="-1">
                                                                                        <form
                                                                                            action="{{ route('employee.destroy', $experience->id) }}"
                                                                                            method="POST"
                                                                            ...
                                                                            @empty
                                                                                <tr>
                                                                                    <td colspan="3">There are no resume
                                                                                        lines on this employee. Why not add
                                                                                        a new one ?</td>
                                                                                </tr>
                                                                            @endforelse
                                                                ...
                                                                <div class="o_list_renderer o_renderer table-responsive"
                                                                    ...
                                                                    <div name="skills_header"
                                                                        ...
                                                                        Skills <a
                                                                            ...
                                                                            Timeline </a></div>
                                                                    <table
                                                                        class="o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped mb-1 o_skill_table"
                                                                        style="table-layout: fixed;">
                                                                        <thead style="visibility: collapse;">
                                                                            <tr>
                                                                                <th data-tooltip-delay="1000"
                                                                                    tabindex="-1" data-name="skill_id"
                                                                                    ...
                                                                                    data-tooltip-info="{&quot;viewMode&quot;:&quot;list&quot;,&quot;resModel&quot;:&quot;hr.employee.skill&quot;,&quot;debug&quot;:false,&quot;field&quot;:{&quot;name&quot;:&quot;skill_id&quot;,&quot;label&quot;:&quot;Skill&quot;,&quot;type&quot;:&quot;many2one&quot;,&quot;widget&quot;:null,&quot;context&quot;:&quot;{}&quot;,&quot;domain&quot;:&quot;[('skill_type_id', '=', skill_type_id)]&quot;,&quot;invisible&quot;:null,&quot;column_invisible&quot;:null,&quot;readonly&quot;:null,&quot;required&quot;:&quot;True&quot;,&quot;changeDefault&quot;:false,&quot;relation&quot;:&quot;hr.skill&quot;}}"
                                                                                    style="width: 130px;">
                                                                                ...
                                                                                <th data-tooltip-delay="1000"
                                                                                    ...
                                                                                    class="align-middle o_column_sortable position-relative cursor-pointer opacity-trigger-hover w-print-auto"
                                                                                    data-tooltip-template="web.ListHeaderTooltip"
                                                                                    data-tooltip-info="{&quot;viewMode&quot;:&quot;list&quot;,&quot;resModel&quot;:&quot;hr.employee.skill&quot;,&quot;debug&quot;:false,&quot;field&quot;:{&quot;name&quot;:&quot;skill_level_id&quot;,&quot;label&quot;:&quot;Skill Level&quot;,&quot;type&quot;:&quot;many2one&quot;,&quot;widget&quot;:null,&quot;context&quot;:&quot;{}&quot;,&quot;domain&quot;:&quot;[('skill_type_id', '=', skill_type_id)]&quot;,&quot;invisible&quot;:null,&quot;column_invisible&quot;:null,&quot;readonly&quot;:null,&quot;required&quot;:&quot;True&quot;,&quot;changeDefault&quot;:false,&quot;relation&quot;:&quot;hr.skill.level&quot;}}"
                                                                                    style="width: 124px;">
                                                                                    <div class="d-flex"><span
                                                                                ...
                                                                                <th data-tooltip-delay="1000"
                                                                                    ...
                                                                                    data-tooltip-template="web.ListHeaderTooltip"
                                                                                    data-tooltip-info="{&quot;viewMode&quot;:&quot;list&quot;,&quot;resModel&quot;:&quot;hr.employee.skill&quot;,&quot;debug&quot;:false,&quot;field&quot;:{&quot;name&quot;:&quot;level_progress&quot;,&quot;label&quot;:&quot;Progress&quot;,&quot;help&quot;:&quot;Progress from zero knowledge (0%) to fully mastered (100%).&quot;,&quot;type&quot;:&quot;integer&quot;,&quot;widget&quot;:&quot;progressbar&quot;,&quot;widgetDescription&quot;:&quot;Progress Bar&quot;,&quot;context&quot;:&quot;{}&quot;,&quot;invisible&quot;:null,&quot;column_invisible&quot;:null,&quot;readonly&quot;:&quot;True&quot;,&quot;required&quot;:null,&quot;changeDefault&quot;:false}}"
                                                                                    style="width: 257px;">
                                                                        ...
                                                                        <tbody class="ui-sortable">
                                                                            ...
                                                                            {{-- Skill Modal Start --}}
                                                                            <div role="dialog" id="skillModal"
                                                                                class="modal o_technical_modal"
                                                                                tabindex="-1">
                                                                                <div
                                                                                    class="modal-dialog modal-dialog-centered modal-lg">
                                                                                    <div class="modal-content o_form_view o_hr_skills_dialog_form"
                                                                                        style="top: 0px; left: 0px;">
                                                                                        <header class="modal-header">
                                                                                            <h4
                                                                                                class="modal-title text-break">
                                                                                                Select Skills</h4><button
                                                                                                type="button"
                                                                                                class="btn-close"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <label
                                                                                                                            class="o_form_label"
                                                                                                                            for="skill_type_id_0">Skill
                                                                                                                            Type</label>
                                                                                                                    </div>
                                                                                                                    <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                                                                        style="width: 100%;">
                                                                                                                        <div name="skill_type_id"
                                                                                                                            ...
                                                                                                                            <div role="radiogroup"
                                                                                                                                ...
                                                                                                                                <div class="form-check o_radio_item"
                                                                                                                                    ...
                                                                                                                                    <input
                                                                                                                                        ...
                                                                                                                                        data-value="1"
                                                                                                                                        data-index="0"
                                                                                                                                        id="radio_field_0_1"><label
                                                                                                                                        class="form-check-label o_form_label"
                                                                                                                                        for="radio_field_0_1">Languages</label>
                                                                                                                                </div>
                                                                                                                                <div class="form-check o_radio_item"
                                                                                                                                    aria-atomic="true">
                                                                                                                                    <input
                                                                                                                                        ...
                                                                                                                                        data-value="4"
                                                                                                                                        data-index="1"
                                                                                                                                        id="radio_field_0_4"><label
                                                                                                                                        class="form-check-label o_form_label"
                                                                                                                                        for="radio_field_0_4">designer
                                                                                                                                        1</label>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    ...
                                                                                                                    <div class="o_cell flex-grow-1 flex-sm-grow-0"
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <span
                                                                                                                                ...
                                                                                                                                style="flex:1">
                                                                                                                                <div name="level_progress"
                                                                                                                                    class="o_field_widget o_readonly_modifier o_field_progressbar o_hr_skills_progress">
                                                                                                                                    <div
                                                                                                                                        class="o_progressbar w-100 d-flex align-items-center">
                                                                                                                                        <div class="o_progress align-middle overflow-hidden"
                                                                                                                                            aria-valuemin="0"
                                                                                                                                            aria-valuemax="100"
                                                                                                                                            aria-valuenow="15">
                                                                                                                                            <div class="bg-primary h-100"
                                                                                                                                                style="width: min(15%, 100%)">
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                        <div
                                                                                                                                            class="o_progressbar_value d-flex">
                                                                                                                                            <span
                                                                                                                                                class="mx-1">15</span><span>%</span>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            </span>
                                                                                        ...
                                                                                        <footer
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                data-hotkey="c">Save &amp;
                                                                                                Close</button><button
                                                                                                class="btn btn-primary o_form_button_save_new"
                                                                                                data-hotkey="n">Save &amp;
                                                                                                New</button><button
                                                                            ...
                                                                            @foreach ($skills as $skill)
                                                                                <tr
                                                                                    class="o_group_has_content o_group_header">
                                                                                    <th tabindex="-1"
                                                                                        class="o_group_name"
                                                                                        colspan="5">
                                                                                        <div
                                                                                            ...
                                                                                            <!-- Assuming you want to display the employee's name -->
                                                                                            <button
                                                                                                class="btn btn-secondary btn-sm add-skill-popup"
                                                                                                role="button">ADD</button>
                                                                                        </div>
                                                                                    </th>
                                                                                </tr>
                                                                                <tr class="o_data_row"
                                                                                    data-id="datapoint_{{ $skill->id }}">
                                                                                    <td class="o_data_cell cursor-pointer o_field_cell o_list_many2one o_required_modifier"
                                                                                        data-tooltip-delay="1000"
                                                                                        tabindex="-1" name="skill_id"
                                                                                        data-tooltip="{{ $skill->name }}">
                                                                                        {{ $skill->name }}
                                                                                    </td>
                                                                                    @foreach ($skillLevels as $skillLevel)
                                                                                        @if ($skillLevel->skill_type_id == $skill->skill_type_id)
                                                                                            <td class="o_data_cell cursor-pointer o_field_cell o_list_many2one o_required_modifier"
                                                                                                data-tooltip-delay="1000"
                                                                                                tabindex="-1"
                                                                                                name="skill_level_id"
                                                                                                data-tooltip="{{ $skillLevel->name }}">
                                                                                                {{ $skillLevel->name }}
                                                                                            </td>
                                                                                            <td class="o_data_cell cursor-pointer o_field_cell o_list_number o_progressbar_cell o_readonly_modifier"
                                                                                                data-tooltip-delay="1000"
                                                                                                tabindex="-1"
                                                                                                name="level_progress">
                                                                                                <div name="level_progress"
                                                                                                    class="o_field_widget o_readonly_modifier o_field_progressbar">
                                                                                                    <div
                                                                                                        class="o_progressbar w-100 d-flex align-items-center">
                                                                                                        <div class="o_progress align-middle overflow-hidden"
                                                                                                            aria-valuemin="0"
                                                                                                            aria-valuemax="100"
                                                                                                            aria-valuenow="{{ $skillLevel->level }}">
                                                                                                            <div class="bg-primary h-100"
                                                                                                                style="width: min({{ $skillLevel->level }}%, 100%)">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div
                                                                                                            class="o_progressbar_value d-flex">
                                                                                                            <span
                                                                                                                class="mx-1">{{ $skillLevel->level }}</span><span>%</span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                        ...
                                        <div class="tab-pane fade" id="work_information">
                                            <div id="o_work_employee_container" class="d-lg-flex">
                                                    ...
                                                    <div class="o_inner_group grid">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="work_location_id_0">Work Location</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="work_location_id"
                                                                    class="o_field_widget o_field_many2one">
                                                                    <div class="o_field_many2one_selection">
                                                                        <div class="o_input_dropdown">
                                                                            <div class="o-autocomplete dropdown"><input
                                                    ...
                                                    <div class="o_inner_group grid hide-group-if-empty">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="timesheet_manager_id_0">Timesheet<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;Select the user responsible for approving \&quot;Timesheet\&quot; of this employee.\nIf empty, the approval is done by a Timesheets > Administrator or a Timesheets > User: all timesheets (as determined in the users settings).&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="timesheet_manager_id"
                                                                    class="o_field_widget o_field_many2one_avatar">
                                                    ...
                                                    <div class="o_inner_group grid">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="resource_calendar_id_0">Working Hours</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="resource_calendar_id"
                                                                    class="o_field_widget o_field_many2one">
                                                                    <div class="o_field_many2one_selection">
                                                                        <div class="o_input_dropdown">
                                                                            <div class="o-autocomplete dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="tz_0">Timezone<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;This field is used in order to define in which timezone the employee will work.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                    ...
                                                    <div class="o_inner_group grid">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="planning_role_ids_0">Roles<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;Roles that the employee can fill in. When creating a shift for this employee, only the shift templates for these roles will be displayed.\nSimilarly, only the open shifts available for these roles will be sent to the employee when the schedule is published.\nAdditionally, the employee will only be assigned orders for these roles (with the default planning role having precedence over the other ones).\nLeave empty for the employee to be assigned shifts regardless of the role.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="planning_role_ids"
                                                                    class="o_field_widget o_field_many2many_tags">
                                                                    <div
                                                                        class="o_field_tags d-inline-flex flex-wrap gap-1 mw-100 o_tags_input o_input">
                                                                        <span
                                                                            class="o_tag position-relative d-inline-flex align-items-center user-select-none mw-100 o_badge badge rounded-pill lh-1 o_tag_color_8"
                                                                            tabindex="-1" data-color="8"
                                                                            title="default role">
                                                                            <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="default_planning_role_id_0">Default Role<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;Role that will be selected by default when creating a shift for this employee.\nThis role will also have precedence over the other roles of the employee when planning orders.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="default_planning_role_id"
                                                                    class="o_field_widget o_field_many2one">
                                                                    <div class="o_field_many2one_selection">
                                                                        <div class="o_input_dropdown">
                                                                            <div class="o-autocomplete dropdown">
                                                ...
                                                <div id="o_employee_right" class="col-lg-4 px-0 ps-lg-5 pe-lg-0">
                                                    ...
                                                    <div name="child_ids"
                                                        class="o_field_widget o_readonly_modifier o_field_hr_org_chart position-relative">
                                                        <div class="o_org_chart_group_up position-relative">
                                                            <div
                                                                class="o_org_chart_entry o_org_chart_entry_manager o_treeEntry d-flex position-relative py-2 overflow-visible">
                                                                <div class="o_media_left position-relative"><a
                                                                        class="o_media_object d-block rounded o_employee_redirect"
                                                                        style="background-image:url('/web/image/hr.employee.public/2/avatar_1024/')"
                                                                        alt="karan vora" data-employee-id="2"
                                                                        href="/mail/view?model=hr.employee.public&amp;res_id=2"></a>
                                                                </div>
                                                                <div
                                                                    ...
                                                                    <a class="o_employee_redirect d-flex flex-column"
                                                                        href="/mail/view?model=hr.employee.public&amp;res_id=2"
                                                                        data-employee-id="2"><b
                                                                            class="o_media_heading m-0 fs-6">karan
                                                                            vora</b><small
                                                                            class="text-muted fw-bold"></small></a><button
                                                                        class="btn p-0 fs-3" tabindex="0"
                                                                        data-bs-trigger="focus"
                                                                        data-bs-toggle="popover"
                                                                        data-emp-name="karan vora" data-emp-id="2"
                                                                        data-emp-dir-subs="1"
                                                                        data-emp-ind-subs="1"><a href="#"
                                                                            class="badge rounded-pill bg-300 border px-2">1</a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <section
                                                            class="o_org_chart_entry_self_container o_org_chart_has_managers">
                                                            <div
                                                                class="o_org_chart_entry o_org_chart_entry_self d-flex position-relative py-2 overflow-visible o_treeEntry">
                                                                <div class="o_media_left position-relative">
                                                                    <div class="o_media_object d-block rounded border border-info"
                                                                        style="background-image:url('/web/image/hr.employee.public/5/avatar_1024/')">
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="d-flex flex-grow-1 align-items-center justify-content-between position-relative px-3">
                                                    ...
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0 o_wrap_label w-100 text-break text-900"
                                                                style=""><label class="o_form_label"
                                                                    for="private_street_0">Private Address</label>
                                                            </div>
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0"
                                                                style="width: 100%;">
                                                                <div class="o_address_format">
                                                                    <div name="private_street"
                                                                        class="o_field_widget o_field_char o_address_street">
                                                                        <input class="o_input" id="private_street_0"
                                                                            type="text" autocomplete="off"
                                                                            placeholder="Street...">
                                                                    </div>
                                                                    <div name="private_street2"
                                                                        class="o_field_widget o_field_char o_address_street">
                                                                        <input class="o_input"
                                                                            id="private_street2_0" type="text"
                                                                            autocomplete="off"
                                                                            placeholder="Street 2...">
                                                                    </div>
                                                                    <div name="private_city"
                                                                        class="o_field_widget o_field_char o_address_city">
                                                                        <input class="o_input" id="private_city_0"
                                                                            type="text" autocomplete="off"
                                                                            placeholder="City">
                                                                    </div>
                                                                    <div name="private_state_id"
                                                                    ...
                                                                    <div name="private_zip"
                                                                        class="o_field_widget o_field_char o_address_zip">
                                                                        <input class="o_input" id="private_zip_0"
                                                                            type="text" autocomplete="off"
                                                                            placeholder="ZIP">
                                                                    </div>
                                                                    <div name="private_country_id"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="private_email_0">Email</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="private_email"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="private_email_0"
                                                                        type="text" autocomplete="off"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="private_phone_0">Phone</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="private_phone"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="private_phone_0"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="o_form_label o_form_label_readonly"
                                                                    for="bank_account_id_0">Bank Account Number<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;Employee bank account to pay salaries&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="bank_account_id"
                                                                    class="o_field_widget o_readonly_modifier o_field_many2one">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="lang_0">Language</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="lang"
                                                                    class="o_field_widget o_field_selection"><select
                                                                        class="o_input pe-3" id="lang_0">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0 o_wrap_label w-100 text-break text-900"
                                                                style=""><label class="o_form_label"
                                                                    for="distance_home_work_0">Home-Work
                                                                    Distance</label></div>
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0"
                                                                style="width: 100%;">
                                                                <div class="o_row" name="div_km_home_work">
                                                                    <div name="distance_home_work"
                                                                        class="o_field_widget o_field_integer o_hr_narrow_field">
                                                                        <input inputmode="numeric" class="o_input"
                                                                            autocomplete="off"
                                                                            id="distance_home_work_0"
                                                                            type="text">
                                                                    </div><span>
                                                                        <div name="distance_home_work_unit"
                                                                            class="o_field_widget o_required_modifier o_field_selection">
                                                                            <select class="o_input pe-3"
                                                                                id="distance_home_work_unit_0">
                                                                                <option value="false"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="private_car_plate_0">Private Car Plate<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;If you have more than one car, just separate the plates by a space.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="private_car_plate"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="private_car_plate_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="spouse_complete_name_0">Spouse Complete
                                                                    Name</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="spouse_complete_name"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="spouse_complete_name_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="spouse_birthdate_0">Spouse Birthdate</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="spouse_birthdate"
                                                                    class="o_field_widget o_field_date">
                                                                    <div class="d-flex gap-2 align-items-center">
                                                                        <input type="text"
                                                                            class="o_input cursor-pointer"
                                                                            autocomplete="off"
                                                                            id="spouse_birthdate_0"
                                                                            data-field="spouse_birthdate">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="children"
                                                                    class="o_field_widget o_field_integer"><input
                                                                        inputmode="numeric" class="o_input"
                                                                        autocomplete="off" id="children_0"
                                                                        type="text"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="emergency_contact_0">Contact Name</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="emergency_contact"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="emergency_contact_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="emergency_phone_0">Contact Phone</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="emergency_phone"
                                                                    class="o_field_widget o_field_char o_force_ltr">
                                                                    <input class="o_input" id="emergency_phone_0"
                                                                        type="text" autocomplete="off">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="country_id_0">Nationality (Country)</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="country_id"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="identification_id_0">Identification
                                                                    No</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="identification_id"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="identification_id_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="o_form_label" for="ssnid_0">SSN
                                                                    No<sup class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;Social Security Number&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="passport_id_0">Passport No</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="passport_id"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="passport_id_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="gender_0">Gender</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="gender"
                                                                    class="o_field_widget o_field_selection"><select
                                                                        class="o_input pe-3" id="gender_0">
                                                                        <option value="false" style="">
                                                                        </option>
                                                            ...
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                ...
                                                                <div name="birthday"
                                                                    ...
                                                                    <div class="d-flex gap-2 align-items-center">
                                                                        <input type="text"
                                                                            class="o_input cursor-pointer"
                                                                            autocomplete="off" id="birthday_0"
                                                                            data-field="birthday">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="place_of_birth_0">Place of Birth</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="place_of_birth"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="place_of_birth_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="country_of_birth_0">Country of Birth</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="country_of_birth"
                                                                    class="o_field_widget o_field_many2one">
                                                                    <div class="o_field_many2one_selection">
                                                                        <div class="o_input_dropdown">
                                                                            <div class="o-autocomplete dropdown">
                                                    ...
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="certificate_0">Certificate Level</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="certificate"
                                                                    class="o_field_widget o_field_selection"><select
                                                                        class="o_input pe-3" id="certificate_0">
                                                                        <option value="false" style="">
                                                                        </option>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="study_field_0">Field of Study</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="study_field"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="study_field_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="study_school_0">School</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="study_school"
                                                                    class="o_field_widget o_field_char"><input
                                                                        class="o_input" id="study_school_0"
                                                                        type="text" autocomplete="off"></div>
                                                            </div>
                                                        </div>
                                                        <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="visa_expire"
                                                                    class="o_field_widget o_field_date">
                                                                    <div class="d-flex gap-2 align-items-center">
                                                                        <input type="text"
                                                                            class="o_input cursor-pointer"
                                                                            autocomplete="off" id="visa_expire_0"
                                                                            data-field="visa_expire">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="work_permit_expiration_date_0">Work Permit
                                                                    Expiration Date</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="work_permit_expiration_date"
                                                                    class="o_field_widget o_field_date">
                                                                    <div class="d-flex gap-2 align-items-center">
                                                                        <input type="text"
                                                                            class="o_input cursor-pointer"
                                                                            autocomplete="off"
                                                                            id="work_permit_expiration_date_0"
                                                                            data-field="work_permit_expiration_date">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="has_work_permit_0">Work Permit</label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="has_work_permit"
                                                                    class="o_field_widget o_field_work_permit_upload">
                                                                    <label
                                                                        class="o_select_file_button btn btn-secondary"><span
                                                                            style="display:contents"> Upload your file
                                                ...
                                                <div class="o_group row align-items-start">
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                                <label class="o_form_label"
                                                                    for="employee_type_0">Employee Type<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;The employee type. Although the primary purpose may seem to categorize employees, this field has also an impact in the Contract History. Only Employee type is supposed to be under contract and will have a Contract History.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                                <div name="employee_type"
                                                                    class="o_field_widget o_required_modifier o_field_selection">
                                                                    <select class="o_input pe-3"
                                                                        id="employee_type_0">
                                                                        <option value="false" style="display:none">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="o_form_label" for="user_id_1">Related
                                                                    User<sup class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;Related user name for the resource to manage its access.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                    ...
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="o_form_label" for="pin_0">PIN
                                                                    Code<sup class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;PIN used to Check In/Out in the Kiosk Mode of the Attendance application (if enabled in Configuration) and to change the cashier in the Point of Sale application.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                                style="width: 100%;">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0 o_wrap_label w-100 text-break text-900"
                                                                style=""><label class="o_form_label"
                                                                    for="barcode_0">Badge ID<sup
                                                                        class="text-info p-1"
                                                                        data-tooltip-template="web.FieldTooltip"
                                                                        data-tooltip-info="{&quot;field&quot;:{&quot;help&quot;:&quot;ID used for employee identification.&quot;}}"
                                                                        data-tooltip-touch-tap-to-show="true">?</sup></label>
                                                            </div>
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0"
                                                                style="width: 100%;">
                                                                <div class="o_row">
                                                                    <div name="barcode"
                                                                        class="o_field_widget o_field_char"><input
                                                                            ...
                                                                            type="text" autocomplete="off"></div>
                                                                    <button invisible="barcode" class="btn btn-link"
                                                                        name="generate_random_barcode"
                                                                        type="object"><span>Generate</span></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="o_inner_group grid col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0 o_wrap_label w-100 text-break text-900"
                                                                style=""><label class="o_form_label"
                                                                    for="hourly_cost_0">Hourly Cost</label></div>
                                                            <div class="o_cell flex-grow-1 flex-sm-grow-0"
                                                                style="width: 100%;">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="o-mail-Message-avatarContainer position-relative bg-view cursor-pointer"
                                                            aria-label="Open card"><img
                                                                ...
                                                                src="{{ asset('images/Employees.png') }}">
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="o_mail_note_title fw-bold">
                                                                                    Original note:</div>
                                                                                <div>
                                                                                    <ul>
                                                                                        <li><br></li>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="mx-1"><span
                                                                    ...
                                                                    role="button" tabindex="0"><i
                                                                        role="img" aria-label="Delivery failure"
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, employee) {
                            dropdown.append(
                                '<li class="o-autocomplete--dropdown-item ui-menu-item d-block"><a role="option" href="#" class="dropdown-item ui-menu-item-wrapper text-truncate" data-id="' +
            ...
            $(document).on('click', '.dropdown-item', function() {
                ...
                $('#employee_id_get').data('id',
                id); // Store the employee ID in the input field's data attribute
