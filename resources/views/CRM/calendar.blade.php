        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer modal-footer-custom gap-1" style="justify-content: start;">
                    <button type="button" class="btn btn-primary" id="favConfirmDelete" style="background-color:#714B67;border: none;font-weight: 500;">Delete Filter</button>
...
<div id="eventModal" class="modal event-model" style="display: none;">
    <div class="event-modal-content">
        ...
        <div class="event-modal-footer gap-2">
            <button id="editEvent" class="btn btn-primary mt-2">Edit</button>
            <button id="deleteEvent" class="btn btn-secondary mt-2">Delete</button>
        </div>
    </div>
</div>

<!-- Confirmation Modal Structure -->
<div id="deleteConfirmationModal" class="modal event-model" style="display: none;">
    <div class="event-modal-content modal-content_new">
        <div class="delete-modal-header delete-model">
            <h4 class="modal-title text-break">Bye-bye, record!</h4>
            <span id="closeDeleteModal" class="event-modal-close">&times;</span>
            <hr>
        </div>
        <div class="modal-body">
            <p class="dfjhsfj">
        ...
        <div class="event-modal-footer gap-2">
            <button id="confirmDelete" class="btn btn-primary mt-2">Delete</button>
            <button id="cancelDelete" class="btn btn-secondary mt-2">No, keep it</button>
        </div>
    </div>
</div>
...
<script>
    ...
    $.ajax({
        ...
        $(document).on('click', '.delete-item', function() {
            ...
            $('#favConfirmDelete').data('id', itemId); // Store the ID in the confirm button
            var modal = new bootstrap.Modal(document.getElementById('deleteModal'));
            modal.show();
        });

        $('#favConfirmDelete').on('click', function() {
